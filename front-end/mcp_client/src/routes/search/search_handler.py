...
class SearchHandler:
    ...
    async def _get_table_schema(self, query: str) -> Dict[str, Any]:
        ...
        async with self._mcp_client as client:
            ...
            query_embeddings = [
                ...
                0.483137845993042,
                -0.14644187688827515,
                -0.007873114198446274,
                0.25349706411361694,
                0.6580443382263184,
                -0.050150346010923386,
                -0.43290236592292786,
                -0.7065499424934387,
                -0.678246796131134,
                0.2815926969051361,
                ...
                1.524175763130188,
                -0.3412266671657562,
                0.015517659485340118,
                -0.0754397064447403,
                0.579332709312439,
                -0.31390196084976196,
                -1.4991686344146729,
                0.42606496810913086,
                0.0029971152544021606,
                0.6698721051216125,
                -0.4441486597061157,
                -0.7565924525260925,
                -0.6338880062103271,
                ...
                -0.6238417625427246,
                0.3569347858428955,
                -0.008007101714611053,
                -0.05141659080982208,
                -0.1515110731124878,
                0.07742591202259064,
                -0.19394001364707947,
                -0.2201472818851471,
                0.039986997842788696,
                0.9137195348739624,
                -0.04269445687532425,
                0.4055884778499603,
                -0.366254985332489,
                -0.1138417050242424,
                0.013236124068498611,
                -0.7584112286567688,
                -0.32698962092399597,
                0.3664434254169464,
                0.21485979855060577,
                ...
                -0.8472467064857483,
                -0.11761941015720367,
                -0.00016727298498153687,
                -0.262254536151886,
                0.04988788813352585,
                -0.002112012356519699,
                0.17206791043281555,
                0.4640192687511444,
                -0.42548078298568726,
                -0.29154765605926514,
    ...
    async def _execute_sql_statement(self, query: str) -> List[Dict[str, Any]]:
        ...
        async with self._mcp_client as client:
            result = await client.call_tool(
                "execute_sql_statement", {"user_query": query}
            )
            return result.data
